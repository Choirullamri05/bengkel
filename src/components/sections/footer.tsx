                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <p className="text-sm text-gray-400 mb-4">
                            {siteConfig.tagline}. Melayani {siteConfig.serviceArea.join(", ")} dan sekitarnya.
                        </p>
                    ...
                    {/* Quick Links */}
                    <div>
                        <h3 className="font-semibold text-white mb-4 text-base">Menu</h3>
                    ...
                    {/* Services */}
                    <div>
                        <h3 className="font-semibold text-white mb-4 text-base">Layanan</h3>
                        <ul className="space-y-2">
                    ...
                    {/* Contact */}
                    <div>
                        <h3 className="font-semibold text-white mb-4 text-base">Kontak</h3>
